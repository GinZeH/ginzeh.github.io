...
/**
 * expressive-code配置
 * @see https://expressivecode.com/
 * 修改本配置后需要重启Astro开发服务器才能生效
 */

export const expressiveCodeConfig: ExpressiveCodeConfig = {
	// 暗色主题（用于暗色模式）
	darkTheme: expressiveCodeSettings.theme ?? "one-dark-pro",

	// 亮色主题（用于亮色模式）
	lightTheme: expressiveCodeSettings.theme === "github-dark" ? "github-light" : "one-light",

	// 更多样式请看expressive-code的官方文档
	// https://expressivecode.com/guides/themes/
